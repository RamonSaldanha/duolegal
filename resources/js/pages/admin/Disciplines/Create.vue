...
const submit = () => {
  ...
  router.post(route('admin.disciplines.store'), form.value, {
    onError: (e) => {
      errors.value = e;
...
<template>
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="container max-w-2xl p-8">
      <Card>
        <CardHeader>
          <CardTitle class="text-2xl font-bold">Nova Disciplina</CardTitle>
          <CardDescription>
            Crie uma nova disciplina e associe as legislacoes correspondentes.
          </CardDescription>
        </CardHeader>
          ...
          <form @submit.prevent="submit" class="space-y-6">
            ...
            <div class="space-y-3">
              ...
              <div class="space-y-2 max-h-64 overflow-y-auto border rounded-md p-3">
                <div
                  v-for="leg in props.legislations"
                  :key="leg.id"
                ...
                <p v-if="props.legislations.length === 0" class="text-sm text-muted-foreground text-center py-2">
