    ...
    <AppLayout>
        <div class="container py-8 px-4">
            <div class="max-w-4xl mx-auto">
                ...
                <!-- Header -->
                <div class="mb-8">
                    <Link :href="route('challenges.index')" class="text-sm text-primary hover:underline mb-4 inline-flex items-center">
                        <ChevronLeft class="w-4 h-4 mr-1" />
                        Voltar aos Desafios
                    </Link>
                    <h1 class="text-3xl font-bold">Criar Novo Desafio</h1>
                    <p class="text-muted-foreground mt-2">
                        Crie um desafio personalizado selecionando as leis e artigos que deseja incluir
                    </p>
                </div>
                ...
                <form @submit.prevent="submitForm" class="space-y-8">
                    ...
                    <div class="flex items-center justify-between gap-4">
                        ...
                        >
                            ...
                            {{ processing ? 'Criando...' : 'Criar Desafio' }}
                        </GameButton>
                    </div>
                </form>
            </div>
...
import { ChevronLeft, ChevronDown, Search, Plus, X, Loader2 } from 'lucide-vue-next';
...
const submitForm = () => {
    ...
    router.post(route('challenges.store'), form.value, {
        onFinish: () => {
